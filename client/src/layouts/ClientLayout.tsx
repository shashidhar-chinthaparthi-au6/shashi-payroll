      ...
      >
        <Toolbar>
          ...
          <Typography variant="h6" noWrap component="div" sx={{ flexGrow: 1, fontWeight: 600 }}>
            {menuItems.find(item => item.path === location.pathname)?.title || 'Client Portal'}
          </Typography>
          <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
            ...
            >
              <MenuItem onClick={handleToggleTheme} sx={{ borderRadius: 1 }}>
                {mode === 'light' ? <DarkModeIcon fontSize="small" /> : <LightModeIcon fontSize="small" />}
                <Box sx={{ ml: 1 }}>{mode === 'light' ? 'Dark Mode' : 'Light Mode'}</Box>
              </MenuItem>
              <MenuItem onClick={() => { handleCloseUserMenu(); navigate('/profile'); }} sx={{ borderRadius: 1 }}>
                <AccountCircleIcon fontSize="small" />
                <Box sx={{ ml: 1 }}>Profile</Box>
              </MenuItem>
              <MenuItem onClick={() => { handleCloseUserMenu(); handleLogout(); }} sx={{ borderRadius: 1 }}>
        ...
        <IconButton
          ...
          sx={{ 
            ...
            boxShadow: mode === 'light' 
              ? '0 4px 20px rgba(31, 41, 55, 0.3), 0 2px 8px rgba(0,0,0,0.1)'
            ...
            '&:hover': {
              ...
              transform: 'scale(1.1)',
              boxShadow: mode === 'light' 
                ? '0 6px 25px rgba(31, 41, 55, 0.4), 0 3px 12px rgba(0,0,0,0.15)'
